...
class RDMNet(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # if False:
            ...
            if self.vis:
                vis_shifte_node(ori_src_points_c, ori_ref_points_c, shifted_src_points_c, shifted_ref_points_c, src_points_f, ref_points_f,
                                src_masks=src_masks,
                                ref_masks=ref_masks,
                    color=[1,0.5,0],
        ...
        if self.vis:
            visualization(
                ...
                src_node_knn_masks=src_node_knn_masks,
                ref_node_knn_indices=ref_node_knn_indices,
                ref_node_knn_masks=ref_node_knn_masks,
