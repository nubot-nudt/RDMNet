...
class SparseDataset(Dataset):
    ...
    def __init__(self, opt):
        ...
        self.train_path = opt.data.apollo_root
    ...
    def get_video_odometry(self, drive, indices=None, ext='.txt', return_all=False):
        if self.IS_ODOMETRY:
            data_path = self.train_path + '/kitti_format/MapData/ColumbiaPark/2018-09-21/%02d/poses.txt' % drive
    ...
    def _get_velodyne_fn(self, drive, t):
        if self.IS_ODOMETRY:
            fname = self.train_path + '/kitti_format/MapData/ColumbiaPark/2018-09-21/%02d/velodyne/%06d.bin' % (drive, t)
        return fname
    ...
    def prepare_kitti_pairs(self):
        ...
        for seq in self.DATA_FILES:
            ...
            fnames = glob.glob(self.train_path + '/kitti_format/MapData/ColumbiaPark/2018-09-21/%02d/velodyne/*.bin' % seq)
            ...
            # more_than_10 = pdist > 15
            curr_time = inames[0]
            f = open(os.path.join(self.train_path,'icp10','%02d'% seq),'a')
