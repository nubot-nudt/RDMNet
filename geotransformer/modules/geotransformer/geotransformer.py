...
from geotransformer.modules.transformer import SinusoidalPositionalEmbedding, RPEConditionalTransformer, VanillaConditionalTransformer, PEConditionalTransformer,LRPEConditionalTransformer,LearnablePositionalEmbedding
...
class vanillaTransformer(nn.Module):
    def __init__(
        ...
        #     blocks, hidden_dim, num_heads, dropout=dropout, activation_fn=activation_fn
        # )
        self.transformer = VanillaConditionalTransformer(
            blocks, hidden_dim, num_heads, dropout=dropout, activation_fn=activation_fn
        )
        # VanillaConditionalTransformer, PEConditionalTransformer,LRPEConditionalTransformer
        self.out_proj = nn.Linear(hidden_dim, output_dim)
