...
# sch
# borrow from overlapnet
def registration_with_ransac_from_featurematch(
    src_points,
    tgt_points,
    src_feats,
    tgt_feats,
    ...
    src_feat.data = src_feats
    tgt_feat = o3d.pipelines.registration.Feature()
    tgt_feat.data = tgt_feats

    result_ransac = o3d.pipelines.registration.registration_ransac_based_on_feature_matching(
        src_pcd, tgt_pcd, src_feat, tgt_feat,distance_threshold,
